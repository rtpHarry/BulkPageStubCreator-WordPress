        ...
        <div class="wrap">
            ...
            <?php if(BPSC_DEBUG) { ?>
                <div class="notice notice-error">
                    <p><strong><?php esc_html_e('WARNING - Debug mode is enabled. Disable before deploying to production.'); ?></strong></p>
                </div>
            <?php } ?>
...
contact-this-company"); 
    ...
    public function add_admin_page_link() {
        ...
        add_management_page("Bulk Page Stub Creator", "Bulk Page Stub Creator", "publish_pages", 
            "bulk-page-stub-creator", array($this, 'admin_page'));
    }
}
